...
<div id="messagelistcontainer" class="container is-fluid">
    ...
    <table id="results" class="table is-striped is-condensed is-narrow is-fullwidth">
      <thead>
        <tr>
          ...
          <th id="date-header">
             <?php print $text_date; ?>
             <a xid="date" xorder="1" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-up<?php if($sort == 'date' && $order == 1) { ?> bottomborder<?php } ?>"></i></a>
             <a xid="date" xorder="0" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-down<?php if($sort == 'date' && $order == 0) { ?> bottomborder<?php } ?>"></i></a>
          </th>
          <th id="from-header">
             <?php print $text_from; ?>
             <a xid="from" xorder="1" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-up<?php if($sort == 'from' && $order == 1) { ?> bottomborder<?php } ?>"></i></a>
             <a xid="from" xorder="0" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-down<?php if($sort == 'from' && $order == 0) { ?> bottomborder<?php } ?>"></i></a>
          </th>
          <th id="to-header">
             <?php print $text_to; ?>
             <a xid="to" xorder="1" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-up"></i></a>
             <a xid="to" xorder="0" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-down"></i></a>
          </th>
          <th id="subject-header">
             <?php print $text_subject; ?>
             <a xid="subj" xorder="1" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-up<?php if($sort == 'subj' && $order == 1) { ?> bottomborder<?php } ?>"></i></a>
             <a xid="subj" xorder="0" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-down<?php if($sort == 'subj' && $order == 0) { ?> bottomborder<?php } ?>"></i></a>
          </th>
          <th id="size-header">
             <?php print $text_size; ?>
             <a xid="size" xorder="1" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-up<?php if($sort == 'size' && $order == 1) { ?> bottomborder<?php } ?>"></i></a>
             <a xid="size" xorder="0" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-down<?php if($sort == 'size' && $order == 0) { ?> bottomborder<?php } ?>"></i></a>
          </th>
          <th id="spam-header"><i class="fas fa-exclamation-triangle is-medium" title="<?php print $text_spam_flag; ?>"></i></th>
          <th id="attachment-header"><i class="fas fa-paperclip is-medium" title="<?php print $text_attachment_flag; ?>"></i></th>
          <th id="note-header"><i class="far fa-comment-alt" title="<?php print $text_notes_flag; ?>"></i></th>
    ...
    <?php $i=0; foreach ($messages as $message) { ?>
         ...
         <tr onmouseover="Piler.current_message_id = <?php print $message['id']; ?>; return false;" id="e_<?php print $message['id']; ?>" class="resultrow new <?php if($message['deleted'] == 1) { ?>xxx<?php } ?>" onclick="Piler.view_message_by_pos(<?php print $i; ?>);">
            ...
            <td id="c7_r<?php print $i; ?>" class="resultcell size is-right"><?php print $message['size']; ?></td>
            <td id="c8_r<?php print $i; ?>" class="resultcell end"><?php if($message['spam'] == 1) { ?><i class="fas fa-exclamation-triangle" title="<?php print $text_spam_flag; ?>"></i><?php } else { ?>&nbsp;<?php } ?></td>
            <td id="c9_r<?php print $i; ?>" class="resultcell end"><?php if($message['attachments'] > 0) { ?><i class="fas fa-paperclip" title="<?php print $text_attachment_flag; ?>"></i><?php } else { ?>&nbsp;<?php } ?></td>
            <td id="c10_r<?php print $i; ?>" class="resultcell end"><?php if($message['note']) { ?><i class="far fa-comment-alt" title="<?php print $message['note']; ?>"></i><?php } else { ?>&nbsp;<?php } ?></td>
    ...
    <?php $i++; } ?>
      ...
      <tfoot>
        <tr>
          ...
          <th id="date-header">
             <?php print $text_date; ?>
             <a xid="date" xorder="1" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-up"></i></a>
             <a xid="date" xorder="0" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-down"></i></a>
          </th>
          <th id="from-header">
             <?php print $text_from; ?>
             <a xid="from" xorder="1" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-up"></i></a>
             <a xid="from" xorder="0" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-down"></i></a>
          </th>
          <th id="to-header">
             <?php print $text_to; ?>
             <a xid="to" xorder="1" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-up"></i></a>
          ...
          <th id="subject-header">
             <?php print $text_subject; ?>
             <a xid="subj" xorder="1" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-up"></i></a>
             <a xid="subj" xorder="0" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-down"></i></a>
          </th>
          <th id="size-header">
             <?php print $text_size; ?>
             <a xid="size" xorder="1" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-up"></i></a>
             <a xid="size" xorder="0" onclick="Piler.changeOrder(this);"><i class="fas fa-sort-down"></i></a>
          </th>
...
<div id="messagelistfooter" class="boxfooter">
    ...
    <?php } else { print $text_none_found; } ?>
        ...
        <div id="functionrow" class="field">
            ...
            <?php } ?>
                <a href="#" class="button is-primary is-small" onclick="Piler.download_messages();"  title="<?php print $text_bulk_download; ?>"><i class="fas fa-cloud-download-alt"></i></a>
